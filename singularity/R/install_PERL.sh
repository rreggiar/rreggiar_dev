...
apt-get install -y build-essential libfile-which-perl libhtml-template-perl libjson-perl libxml-parser-perl libsys-info-perl liblog-log4perl-perl libxml-compile-perl
